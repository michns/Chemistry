...
The HAVING clause is useful if we need to filter our data in relation to the
aggregate functions. However, if we want to perform column-based filtering,
we can simply use WHERE clause.
